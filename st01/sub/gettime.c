...
/*----------------------------------------------------------------------*/
{
    ...
    /* HHMMSSmmm (9 bytes)  */
    sprintf(p_time, "%02d%02d%02d%03ld",
...
/*----------------------------------------------------------------------*/
{
    ...
    /* yyyymmddhhmmss (14 bytes)    */
    strftime(p_time, 15, "%Y%m%d%H%M%S", date);
    sprintf(&p_time[14], "%03ld", tv.tv_usec / 1000);
...
/*----------------------------------------------------------------------*/
{
    ...
    sprintf(p_time, "%010ld%02d:%02d:%02d-%03ld", tv.tv_sec,
            date->tm_hour, date->tm_min, date->tm_sec, tv.tv_usec / 1000);
...
/*----------------------------------------------------------------------*/
{
    ...
    sprintf(p_time, "%010ld%02d%02d%02d%06ld", tv.tv_sec,
