...
/*----------------------------------------------------------------------*/
{
	...
	switch (process_no)
	{
		...
		case	OK:
			...
			if (strlen(full_path) < sizeof(path) - 1)
			{
				strcpy(path, full_path);  // strcpy¿ ¿¿¿¿ NULL ¿¿
			}
			else
			{
				// ¿¿ ¿¿ ¿¿ ¿ ¿¿¿¿ ¿¿
...
/**************************************************************************
   Functions      : . SHM Backup Process ±âµ¿
   Parameters IN  : .
   Parameters OUT : .
   Return Code    : . void
**************************************************************************/
