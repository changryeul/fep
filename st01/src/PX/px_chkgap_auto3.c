...
/*----------------------------------------------------------------------*/
{
    ...
    if ((argc != 1 && argc != 2 && argc != 5) ||
        ...
        printf("  e.g. 1) %s\n", argv[0]);
        printf("       2) %s 31\n", argv[0]);
        printf("       3) %s 31 20071029 092030 133000\n", argv[0]);
        printf("==========================================================\n");
        exit(FAIL);
    }
    ...
    if (argc == 2 || argc == 5) {
        ...
        printf("\033[1mdate(e.g. 00000000, 20071029, ...) ?\033[0m ");
        fflush(stdout);
    ...
    while (fgets(buf, sizeof (buf), fp) != NULL) {
        if ((memcmp(buf+62, "][", 2) != 0) ||
                ...
                (memcmp(buf+283,"TCHODR10003", 11) != 0)) {
            memset(buf, 0, sizeof (buf));
            continue;
        }
