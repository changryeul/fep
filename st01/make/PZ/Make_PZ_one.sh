##########################################################################
#	Module	: make shell - PZ (관리) - make only one program
#	File	: Make_PZ_one.sh
##########################################################################
...
case $osname in
	...
	#	DEF_TMP="-D_XOPEN_SOURCE=500 -lc -lnsl"; export DEF_TMP;;
		#DEF_TMP="-D_XOPEN_SOURCE=700 -D_DEFAULT_SOURCE -lc -lnsl"	export DEF_TMP;;
