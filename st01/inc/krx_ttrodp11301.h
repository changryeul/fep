#ifndef _KRX_TTRODP11301_H
#define _KRX_TTRODP11301_H
/*------------------------------------------------------------------------
#   전문   : TTRODP11301 회원처리호가(정상) - 응답, 현/파 공용, DATA 318 bytes
#   규격   : KRX EXTURE 3.0 v3.24 (2026-07-30 주식선물옵션 정기변경)
#   근거   : docs/reference/krx-exture3/ (interface-list.csv '길이(헤재외)'=318, '현/파')
#
#   회원사가 송신한 호가(TCHODR1xxxx)에 대한 거래소 처리결과 응답.
#   거부는 TTRODP11321, 자동취소는 TTRODP11303 로 별도 전문(각각 헤더 분리).
#
#   [전문 관리 규약]
...
#     - ★신규/★변경 = 차세대(v3.24) 변경 항목
#     - sizeof(TTRODP11301_DATA)==318 회귀가드: test/unit/test_krx_struct.c
------------------------------------------------------------------------*/
typedef struct {
...
}   TTRODP11301_DATA;   /* DATA 길이 합계 = 318 */

#endif  /* _KRX_TTRODP11301_H */
