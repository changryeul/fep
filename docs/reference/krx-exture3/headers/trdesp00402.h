#ifndef _KRX_TRDESP00402_H
#define _KRX_TRDESP00402_H

/* TRDESP00402 선물옵션 상하한가 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TRDESP00401) */
