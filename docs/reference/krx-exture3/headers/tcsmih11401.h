#ifndef _KRX_TCSMIH11401_H
#define _KRX_TCSMIH11401_H

/* TCSMIH11401 익일상장종목의종목별내재변동성(파생시장) - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
...
typedef struct {
    ...
    char Implied_Volitility[11];                /*   11 내재변동성 (Long 11) */
    char Filler_Value[696];                     /*   12 필러값 (String 696) */
} TCSMIH11401_DATA;

#endif  /* _KRX_TCSMIH11401_H */
