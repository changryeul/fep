#ifndef _KRX_TTSSDP90010_H
#define _KRX_TTSSDP90010_H

/* TTSSDP90010 착오추정호가적출 회원사송신 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TTSSDP20010) */
