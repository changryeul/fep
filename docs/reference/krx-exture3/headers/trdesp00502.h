#ifndef _KRX_TRDESP00502_H
#define _KRX_TRDESP00502_H

/* TRDESP00502 옵션기준가 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TRDESP00501) */
