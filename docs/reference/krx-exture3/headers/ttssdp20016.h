#ifndef _KRX_TTSSDP20016_H
#define _KRX_TTSSDP20016_H

/* TTSSDP20016 협의(협의대량, EFP, FLEX)비상주문호가재송신(자동취소) - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
