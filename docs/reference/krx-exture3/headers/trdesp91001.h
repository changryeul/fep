#ifndef _KRX_TRDESP91001_H
#define _KRX_TRDESP91001_H

/* TRDESP91001 파생종목정보 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TRDESP01001) */
