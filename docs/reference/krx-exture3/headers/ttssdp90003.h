#ifndef _KRX_TTSSDP90003_H
#define _KRX_TTSSDP90003_H

/* TTSSDP90003 일별 종목별 주문체결 수량송신 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TTSSDP20003) */
