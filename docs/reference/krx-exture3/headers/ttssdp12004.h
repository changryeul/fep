#ifndef _KRX_TTSSDP12004_H
#define _KRX_TTSSDP12004_H

/* TTSSDP12004 회원별약정(프리마켓) - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TTSSDP10004) */
