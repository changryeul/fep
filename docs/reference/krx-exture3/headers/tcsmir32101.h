#ifndef _KRX_TCSMIR32101_H
#define _KRX_TCSMIR32101_H

/* TCSMIR32101 증권시장착오거래구제신청수신및응답 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* DATA 길이 합계 = 313 (interface-list.csv '길이(헤더제외)'와 대조) */
typedef struct {
    ...
    char Erroneous_Trading_Relief_Application_Rejected_Reason_Code[4];/*   15 착오거래구제신청거부사유코드 (String 4) */
    char Erroneous_Trading_Relief_Application_Time[9];/*   16 착오거래구제신청시각 (String 9) */
} TCSMIR32101_DATA;

#endif  /* _KRX_TCSMIR32101_H */
