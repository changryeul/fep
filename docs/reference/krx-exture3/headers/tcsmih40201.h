#ifndef _KRX_TCSMIH40201_H
#define _KRX_TCSMIH40201_H

/* TCSMIH40201 장중추가증거금_옵션증거금기준가격(파생시장) - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
...
typedef struct {
    ...
    char Margin_Base_Price_Type_Code[2];        /*   15 증거금기준가격구분코드 (String 2) */
    char Filler_Value[174];                     /*   16 필러값 (String 174) */
} TCSMIH40201_DATA;

#endif  /* _KRX_TCSMIH40201_H */
