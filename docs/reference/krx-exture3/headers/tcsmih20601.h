#ifndef _KRX_TCSMIH20601_H
#define _KRX_TCSMIH20601_H

/* TCSMIH20601 옵션결제차금(파생시장) - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
...
typedef struct {
    ...
    char Filler_Value[959];                     /*   20 필러값 (String 959) */
} TCSMIH20601_DATA;

#endif  /* _KRX_TCSMIH20601_H */
