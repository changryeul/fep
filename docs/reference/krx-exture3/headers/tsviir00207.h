#ifndef _KRX_TSVIIR00207_H
#define _KRX_TSVIIR00207_H

/* TSVIIR00207 대체입출금내역 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* DATA 길이 합계 = 498 (interface-list.csv '길이(헤더제외)'와 대조) */
typedef struct {
    ...
    char Alternation_Transfer_In_Out_Amount[22];/*   18 대체입출금액 (Float 22) */
    char Investor_Representative_Account_Number[12];/*   19 투자자대표계좌번호 (String 12) */
    char Investigation_Information_Miscellaneous_Contents[200];/*   20 심리정보기타내용 (String 200) */
} TSVIIR00207_DATA;

#endif  /* _KRX_TSVIIR00207_H */
