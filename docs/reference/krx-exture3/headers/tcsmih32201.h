#ifndef _KRX_TCSMIH32201_H
#define _KRX_TCSMIH32201_H

/* TCSMIH32201 증권시장착오거래구제가격변경접수결과송신 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
...
typedef struct {
    ...
    char Application_Media_Type_Code[1];        /*   18 신청매체구분코드 (String 1) */
    char Erroneous_Trading_Relief_Price_Change_Application_Rejected_Reason_Code[4];/*   19 착오거래구제가격변경신청거부사유코드 (String 4) */
    char Erroneous_Trading_Relief_Price_Change_Application_Time[9];/*   20 착오거래구제가격변경신청시각 (String 9) */
    char Erroneous_Trading_Relief_Price_Change_Accept_Number[10];/*   21 착오거래구제가격변경접수번호 (Long 10) */
    char Erroneous_Trading_Relief_Price_Change_Accept_Time[9];/*   22 착오거래구제가격변경접수시각 (String 9) */
    char Filler[843];                           /*   23 필러 (String 843) */
} TCSMIH32201_DATA;

#endif  /* _KRX_TCSMIH32201_H */
