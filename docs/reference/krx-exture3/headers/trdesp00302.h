#ifndef _KRX_TRDESP00302_H
#define _KRX_TRDESP00302_H

/* TRDESP00302 선물기준가 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TRDESP00301) */
