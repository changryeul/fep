#ifndef _KRX_TTSSDP12001_H
#define _KRX_TTSSDP12001_H

/* TTSSDP12001 불공정거래 모니터링 지원정보 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TTSSDP10001) */
