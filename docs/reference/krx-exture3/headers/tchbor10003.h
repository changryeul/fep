#ifndef _KRX_TCHBOR10003_H
#define _KRX_TCHBOR10003_H

/* TCHBOR10003 대량호가입력 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TCHBOR10001) */
/* DATA 길이 합계 = 307 (interface-list.csv '길이(헤더제외)'와 대조) */
typedef struct {
    ...
    char Order_Identification[10];              /*    7 주문ID ★변경 (String 10) */
    ...
    char Negotiation_Number[6];                 /*   29 협상번호 ★변경 (Long 6) */
    char Block_Trade_Negotiation_Detail_Number[6];/*   30 협상상세번호 ★변경 (Long 6) */
    char Negotiator_Identification[10];         /*   31 협상자ID ★변경 (String 10) */
    char Counterpart_Member_Number[5];          /*   32 상대회원번호 ★변경 (String 5) */
    char Counterpart_Account_Number[12];        /*   33 상대계좌번호 ★변경 (String 12) */
    char Negotiation_Completion_Time[9];        /*   34 협의완료시각 ★변경 (String 9) */
    ...
    char Spot_Prc[11];                          /*   38 현물가격 (Float 11) */
    char Pt_Tp_Cd[2];                           /*   39 PT구분코드 (String 2) */
    char Trd_Mkt_Choic_Tp_Cd[1];                /*   40 거래시장선택구분코드 (String 1) */
    char Srtsell_Id[10];                        /*   41 공매도ID (String 10) */
} TCHBOR10003_DATA;

#endif  /* _KRX_TCHBOR10003_H */
