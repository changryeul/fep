#ifndef _KRX_TCSMIH23701_H
#define _KRX_TCSMIH23701_H

/* TCSMIH23701 착오거래수수료예정내역 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
...
typedef struct {
    ...
    char Trading_Cme_Trading_Fee[22];           /*   14 거래체결CME거래수수료 (Float 22) */
    char Trading_Cme_Clearing_Settlement_Fee[22];/*   15 거래체결CME청산결제수수료 (Float 22) */
