#ifndef _KRX_TCSMIH40301_H
#define _KRX_TCSMIH40301_H

/* TCSMIH40301 장중추가증거금_유지증거금구간별이론가격(파생시장) - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
...
typedef struct {
    ...
    char Maintenance_Margin_Range_Number[16];   /*   18 유지증거금구간수치 (Float 16) */
    char Maintenance_Marign_Range_Theory_Price[16];/*   19 유지증거금구간이론가격
(또는 구간 델타) (Float 16) */
    char Filler_Value[396];                     /*   20 필러값 (String 396) */
} TCSMIH40301_DATA;

#endif  /* _KRX_TCSMIH40301_H */
