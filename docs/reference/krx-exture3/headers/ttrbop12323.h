#ifndef _KRX_TTRBOP12323_H
#define _KRX_TTRBOP12323_H

/* TTRBOP12323 장개시전 협의거래처리호가 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TTRBOP12305) */
