#ifndef _KRX_TTRBTP22301_H
#define _KRX_TTRBTP22301_H

/* TTRBTP22301 회원대량체결결과 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* DATA 길이 합계 = 231 (interface-list.csv '길이(헤더제외)'와 대조) */
typedef struct {
    ...
    char The_Nearby_Month_Trading_Price[11];    /*   21 근월물체결가격 (Float 11) */
    char The_Future_Month_Trading_Price[11];    /*   22 원월물체결가격 (Float 11) */
    char Trust_Company_Number[5];               /*   23 위탁사번호 (String 5) */
} TTRBTP22301_DATA;

#endif  /* _KRX_TTRBTP22301_H */
