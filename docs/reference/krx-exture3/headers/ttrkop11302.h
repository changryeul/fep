#ifndef _KRX_TTRKOP11302_H
#define _KRX_TTRKOP11302_H

/* TTRKOP11302 Kill Switch 처리 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TTRKOP11301) */
