#ifndef _KRX_TCHKOR10001_H
#define _KRX_TCHKOR10001_H

/* TCHKOR10001 Kill Switch 입력 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* DATA 길이 합계 = 147 (interface-list.csv '길이(헤더제외)'와 대조) */
typedef struct {
    ...
    char Decl_Dd[8];                            /*   11 신고일자 (String 8) */
    char Decl_Tm[9];                            /*   12 신고시각 (String 9) */
    char Member_Use_Area[60];                   /*   13 회원사용영역 (String 60) */
} TCHKOR10001_DATA;

#endif  /* _KRX_TCHKOR10001_H */
