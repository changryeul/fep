#ifndef _KRX_TCSMIH10501_H
#define _KRX_TCSMIH10501_H

/* TCSMIH10501 당일거래종목의위탁증거금구간별이론가격(파생시장) - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
...
typedef struct {
    ...
    char Trust_Margin_Range_Number[16];         /*   15 위탁증거금구간수치 (Float 16) */
    char Trust_Margin_Range_Theory_Price[16];   /*   16 위탁증거금구간이론가격
(또는 구간 델타) (Float 16) */
    char Filler_Value[98];                      /*   17 필러값 (String 98) */
} TCSMIH10501_DATA;

#endif  /* _KRX_TCSMIH10501_H */
