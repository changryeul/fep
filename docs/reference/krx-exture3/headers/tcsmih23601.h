#ifndef _KRX_TCSMIH23601_H
#define _KRX_TCSMIH23601_H

/* TCSMIH23601 착오거래옵션결제차금예정내역 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
...
typedef struct {
    ...
    char Filler_Value[952];                     /*   20 필러값 (String 952) */
} TCSMIH23601_DATA;

#endif  /* _KRX_TCSMIH23601_H */
