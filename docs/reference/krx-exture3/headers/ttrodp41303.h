#ifndef _KRX_TTRODP41303_H
#define _KRX_TTRODP41303_H

/* TTRODP41303 채권일반처리호가 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TTRODP41301) */
