#ifndef _KRX_TTSSDP90005_H
#define _KRX_TTSSDP90005_H

/* TTSSDP90005 일반비상주문체결재송신 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TTSSDP20005) */
/* DATA 길이 합계 = 232 (interface-list.csv '길이(헤더제외)'와 대조) */
typedef struct {
    ...
    char Trading_Price[11];                     /*   11 체결가격 ★안내 (Float 11) */
