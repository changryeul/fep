#ifndef _KRX_TCSMIH23502_H
#define _KRX_TCSMIH23502_H

/* TCSMIH23502 착오거래선물일일정산확정내역 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
...
typedef struct {
    ...
    char Filler_Value[988];                     /*   24 필러값 (String 988) */
} TCSMIH23502_DATA;

#endif  /* _KRX_TCSMIH23502_H */
