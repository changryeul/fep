#ifndef _KRX_TTRTDP42301_H
#define _KRX_TTRTDP42301_H

/* TTRTDP42301 채권체결결과(일반,조성) - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* DATA 길이 합계 = 317 (interface-list.csv '길이(헤더제외)'와 대조) */
typedef struct {
