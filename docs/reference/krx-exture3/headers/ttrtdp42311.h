#ifndef _KRX_TTRTDP42311_H
#define _KRX_TTRTDP42311_H

/* TTRTDP42311 채권-체결 (DropCopy) - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
...
typedef struct {
    ...
    char Nego_Partc_Tp_Cd[1];                   /*   40 협상참여구분코드 (String 1) */
} TTRTDP42311_DATA;

#endif  /* _KRX_TTRTDP42311_H */
