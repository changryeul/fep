#ifndef _KRX_TTSSDP90004_H
#define _KRX_TTSSDP90004_H

/* TTSSDP90004 일반비상주문호가재송신 - KRX EXTURE 3.0 v3.24 전문 (자동생성, DATA부) */
/* (변형: 레이아웃 공유 그룹 TTSSDP20004) */
/* DATA 길이 합계 = 296 (interface-list.csv '길이(헤더제외)'와 대조) */
typedef struct {
    ...
    char Order_Rejected_Reason_Code[4];         /*   41 호가거부사유코드 (String 4) */
