...
#elif defined A7915
	sprintf (fifo_name, "%s/PA/pa_7915_ur1", _FEP_FIFO);
#elif defined A7916
	sprintf (fifo_name, "%s/PA/pa_7916_ur1", _FEP_FIFO);
#endif

#if defined A7111||A7211||A7212||A7311||A7411||A7412||A7811||A7911||A7912||A7915||A7916
	/* 전략전달용 FIFO */
