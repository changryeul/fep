...
/*----------------------------------------------------------------------*/
{
	...
	else if (memcmp (sub, "b1", 2) == 0)
		mvaddstr (0, 18, "[1010]선물옵션주문체결(PB):주문,응답,체결");
	else if (memcmp (sub, "a5", 2) == 0)
		mvaddstr (0, 18, "[1010]선물옵션주문체결(PA):Auto주문");
	else if (memcmp (sub, "b5", 2) == 0)
		mvaddstr (0, 18, "[1010]선물옵션주문체결(PB):Auto주문");
	else if (memcmp (sub, "a6", 2) == 0)
		mvaddstr (0, 18, "[1010]선물옵션주문체결(PA):조회");
	else if (memcmp (sub, "a7", 2) == 0)
		mvaddstr (0, 18, "[1010]선물옵션주문체결(PA):시세,한도");
	else if (memcmp (sub, "b7", 2) == 0)
		mvaddstr (0, 18, "[1010]선물옵션주문체결(PB):한도");
	attroff (A_BOLD);
