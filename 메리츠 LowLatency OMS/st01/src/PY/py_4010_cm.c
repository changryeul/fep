...
"tr_s_tm         tr_e_tm         error_cd       error_tm         data_cnt");
	...
	mvaddstr (17, 3, "OD1                       OD2                       OD3");
	mvaddstr (18, 3, "OD4                       OD5                       OD6");
	mvaddstr (19, 3, "OD7                       OD8                       OD9");
	mvaddstr (20, 3, "ODW9");
...
/*----------------------------------------------------------------------*/
{
	...
	if (PROC(Dk,Pk).type == TY_TRS1)						/* TCP 1	*/
	{
		...
		mvaddstr (24, 9, "SPORT");
		mvaddstr (25, 9, "S_CT");
		mvaddstr (26, 9, "client ip                       port");
	}
	else if (PROC(Dk,Pk).type == TY_TRS2)					/* TCP 2	*/
	{
		attron (A_BOLD);
		mvaddstr (22, 0, "[TCP2]");
		mvaddstr (22, 11, "ID  PORT IP              P L N");
		attroff (A_BOLD);

		mvaddstr (22, 47, "l.t2.line_gubun    l.t2.l");
		mvaddstr (23, 7, "P               .   .   .");
		mvaddstr (24, 7, "B               .   .   .");
	}
	...
	for (i = 0; i < 9; i ++)
	{
		...
		{
			MvAddNum (17 + i / 3, 7 + (i % 3) * 26, 2, PROC(Dk,Pk).out_d[i]);
			MvAddStr (17 + i / 3, 10 + (i % 3) * 26, 10, ODN(Dk,Pk,i));
			MvAddNum (17 + i / 3, 21 + (i % 3) * 26, 4, ODS(Dk,Pk,i));
			MvAddNum (17 + i / 3, 26 + (i % 3) * 26, 1, ODC(Dk,Pk,i));
		}

		if (PROC(Dk,Pk).out_f[i] != 0)
		{
...
/* park */
/*
	MvAddNum (20, 8, 1, IDR(Dk,Pk,1,8));
	MvAddNum (20, 10, 1, ODR(Dk,Pk,1,8));
*/

	if (PROC(Dk,Pk).type == TY_TRS1)						/* TCP 1	*/
	{
		MvAddNum (22, 12, 1, PROC(Dk,Pk).l.t1.line_gubun);
		MvAddNum (22, 17, 1, PROC(Dk,Pk).l.t1.port_type);
		MvAddNum (22, 22, 1, PROC(Dk,Pk).l.t1.network_status);
			...
			PROC(Dk,Pk).l.t1.line_gubun == 2)
		{
			...
			{
				MvAddNum (22, 31, 5, TCP1_PORT(Dk,Pk));
				MvAddNum (22, 41, 3, TCP1_IP(Dk,Pk,0));
				MvAddNum (22, 45, 3, TCP1_IP(Dk,Pk,1));
				MvAddNum (22, 49, 3, TCP1_IP(Dk,Pk,2));
				MvAddNum (22, 53, 3, TCP1_IP(Dk,Pk,3));
				MvAddNum (22, 63, 1, TCP1_P_ST(Dk,Pk));
				MvAddNum (23, 14, 1, TCP1_S_ST(Dk,Pk,0));
				MvAddNum (23, 16, 1, TCP1_S_ST(Dk,Pk,1));
				MvAddNum (23, 18, 1, TCP1_S_ST(Dk,Pk,2));
				MvAddNum (23, 20, 1, TCP1_S_ST(Dk,Pk,3));
				MvAddNum (23, 22, 1, TCP1_S_ST(Dk,Pk,4));
				MvAddNum (23, 24, 1, TCP1_S_ST(Dk,Pk,5));
				MvAddNum (23, 26, 1, TCP1_S_ST(Dk,Pk,6));
				MvAddNum (23, 28, 1, TCP1_S_ST(Dk,Pk,7));
				MvAddNum (23, 30, 1, TCP1_S_ST(Dk,Pk,8));
				MvAddNum (24, 15, 5, TCP1_SPORT(Dk,Pk,0));
				MvAddNum (24, 21, 5, TCP1_SPORT(Dk,Pk,1));
				MvAddNum (24, 27, 5, TCP1_SPORT(Dk,Pk,2));
				MvAddNum (24, 33, 5, TCP1_SPORT(Dk,Pk,3));
				MvAddNum (24, 39, 5, TCP1_SPORT(Dk,Pk,4));
				MvAddNum (24, 45, 5, TCP1_SPORT(Dk,Pk,5));
				MvAddNum (24, 51, 5, TCP1_SPORT(Dk,Pk,6));
				MvAddNum (24, 57, 5, TCP1_SPORT(Dk,Pk,7));
				MvAddNum (24, 63, 5, TCP1_SPORT(Dk,Pk,8));
				MvAddNum (25, 14, 5, TCP1_S_CT(Dk,Pk,0));
				MvAddNum (25, 20, 5, TCP1_S_CT(Dk,Pk,1));
				MvAddNum (25, 26, 5, TCP1_S_CT(Dk,Pk,2));
				MvAddNum (25, 32, 5, TCP1_S_CT(Dk,Pk,3));
				MvAddNum (25, 38, 5, TCP1_S_CT(Dk,Pk,4));
				MvAddNum (25, 44, 5, TCP1_S_CT(Dk,Pk,5));
				MvAddNum (25, 50, 5, TCP1_S_CT(Dk,Pk,6));
				MvAddNum (25, 56, 5, TCP1_S_CT(Dk,Pk,7));
				MvAddNum (25, 62, 5, TCP1_S_CT(Dk,Pk,8));
			}
			else
			{
				...
				else
				{
					...
					MvAddStr (26, 19, 15, PROC(Dk,Pk).ip);
					MvAddNum (26, 46, 5, PROC(Dk,Pk).port);
				}
			}
		}
	}
	else if (PROC(Dk,Pk).type == TY_TRS2)					/* TCP 2	*/
	{
		...
		{
			MvAddNum (22, 63, 1, TCP2_LINE_GUBUN(Dk,Pk));
			MvAddNum (22, 73, 3, PROC(Dk,Pk).l.t2.l[0]);
			MvAddNum (23, 10, 3, TCP2_ID(Dk,Pk,0));
			MvAddNum (23, 14, 5, TCP2_PORT(Dk,Pk,0));
			mvaddstr (23, 20, "   .   .   .");
			MvAddNum (23, 20, 3, TCP2_IP1(Dk,Pk,0));
			MvAddNum (23, 24, 3, TCP2_IP2(Dk,Pk,0));
			MvAddNum (23, 28, 3, TCP2_IP3(Dk,Pk,0));
			MvAddNum (23, 32, 3, TCP2_IP4(Dk,Pk,0));
			MvAddNum (23, 36, 1, TCP2_PSTAT(Dk,Pk,0));
			MvAddNum (23, 38, 1, TCP2_LSTAT(Dk,Pk,0));
			MvAddNum (23, 40, 1, TCP2_NSTAT(Dk,Pk,0));
		}

		if (PROC(Dk,Pk).l.t2.l[1] != 0)
		{
			MvAddNum (22, 77, 3, PROC(Dk,Pk).l.t2.l[1]);
			MvAddNum (24, 10, 3, TCP2_ID(Dk,Pk,1));
			MvAddNum (24, 14, 5, TCP2_PORT(Dk,Pk,1));
			mvaddstr (24, 20, "   .   .   .");
			MvAddNum (24, 20, 3, TCP2_IP1(Dk,Pk,1));
			MvAddNum (24, 24, 3, TCP2_IP2(Dk,Pk,1));
			MvAddNum (24, 28, 3, TCP2_IP3(Dk,Pk,1));
			MvAddNum (24, 32, 3, TCP2_IP4(Dk,Pk,1));
			MvAddNum (24, 36, 1, TCP2_PSTAT(Dk,Pk,1));
			MvAddNum (24, 38, 1, TCP2_LSTAT(Dk,Pk,1));
			MvAddNum (24, 40, 1, TCP2_NSTAT(Dk,Pk,1));
		}
	}
	else if (PROC(Dk,Pk).type == TY_URS)					/* UDPIP	*/
	{
