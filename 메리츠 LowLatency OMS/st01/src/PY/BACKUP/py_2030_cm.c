...
/*----------------------------------------------------------------------*/
{
	...
	if (FO_Flag == '1')											/* 선물	*/
	{
		...
		Curr_Arry = Shm_Futures[Sk].C0_Arry_Key;
		...
		memcpy (fms_c0.item_cd, 
				Shm_Futures[Sk].Futures_C0_Arry[Curr_Arry].item_cd, 
				sizeof (FMS_C0) -4);
	}
	else														/* 옵션	*/
	{
		mvaddstr (4, 0, "지수옵션 체결가 (Options_C0)");
		Curr_Arry = Shm_Options[Sk].C0_Arry_Key;
		...
		memcpy (opt_c0.item_cd, 
				Shm_Options[Sk].Options_C0_Arry[Curr_Arry].item_cd,
				sizeof (OPT_C0) - 4);
	}
	...
	if (FO_Flag == '1')											/* 선물	*/
	{
		...
		MvAddStr (6, 9, 8, fms_c0.item_cd);
		MvAddStr (6, 33, 30, Shm_Futures[Sk].Futures_FB.kor_nm);
		MvAddStr (7, 9, 2, fms_c0.chekyul_tm);
		MvAddStr (7, 12, 2, fms_c0.chekyul_tm+2);
		MvAddStr (7, 15, 2, fms_c0.chekyul_tm+4);
		MvAddStr (7, 18, 2, fms_c0.chekyul_tm+6);
		MvAddStr (7, 30, 6, fms_c0.chekyul_qty);
	...
	else														/* 옵션	*/
	{
        ...
        MvAddStr (6, 9, 8, opt_c0.item_cd);
        MvAddStr (6, 33, 30, Shm_Options[Sk].Options_OB.kor_nm);
		MvAddStr (7, 9, 2, opt_c0.chekyul_tm);
		MvAddStr (7, 12, 2, opt_c0.chekyul_tm+2);
		MvAddStr (7, 15, 2, opt_c0.chekyul_tm+4);
		MvAddStr (7, 18, 2, opt_c0.chekyul_tm+6);
