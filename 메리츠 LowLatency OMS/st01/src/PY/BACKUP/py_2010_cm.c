...
/*----------------------------------------------------------------------*/
{
	...
	if (FO_Flag == '1')											/* 선물	*/
	{
		mvaddstr (3, 0, "지수선물 호가 (Futures_H0)");
		memcpy (fms_h0.item_cd, Shm_Futures[Sk].Futures_H0.item_cd,
			sizeof (FMS_H0) - 4);
	}
	else														/* 옵션	*/
	{
		mvaddstr (3, 0, "지수옵션 호가 (Options_H0)");
		memcpy (opt_h0.item_cd, Shm_Options[Sk].Options_H0.item_cd,
			sizeof (OPT_H0) - 4);
	}
	...
	if (FO_Flag == '1')											/* 선물	*/
	{
		...
		MvAddStr (6, 9, 8, fms_h0.item_cd);
		MvAddStr (6, 33, 30, Shm_Futures[Sk].Futures_FB.kor_nm);
		MvAddStr (7, 7, 4, Shm_Futures[Sk].Futures_FB.hlprc);
		MvAddStr (7, 12, 2, Shm_Futures[Sk].Futures_FB.hlprc+4);
		MvAddStr (7, 25, 4, Shm_Futures[Sk].Futures_FB.llprc);
		MvAddStr (7, 30, 2, Shm_Futures[Sk].Futures_FB.llprc+4);
	...
	else														/* 옵션	*/
	{
        ...
        MvAddStr (6, 9, 8, opt_h0.item_cd);
        MvAddStr (6, 33, 30, Shm_Options[Sk].Options_OB.kor_nm);
        MvAddStr (7, 7, 4, Shm_Options[Sk].Options_OB.hlprc);
        MvAddStr (7, 12, 2, Shm_Options[Sk].Options_OB.hlprc+4);
        MvAddStr (7, 25, 4, Shm_Options[Sk].Options_OB.llprc);
        MvAddStr (7, 30, 2, Shm_Options[Sk].Options_OB.llprc+4);
