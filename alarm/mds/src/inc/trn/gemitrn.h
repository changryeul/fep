...
struct	quote {
	...
	char	stat[2];			// trading status
	char	bvol[9];			// Curm. volume traded by buy side aggressor
	char	bcnt[9];			// counts traded by buy side aggressor
	char	svol[9];			// Curm. volume traded by sell side aggressor
	char	scnt[9];			// counts traded by sell side aggressor
	char	otim[1];			// included open time
	char	htim[1];			// touched higher price
	char	ltim[1];			// touched lower price
};
...
typedef struct {
	...
	char    fill[ 2];       /* Filler                               */
	char    fil2[ 3];       /* Filler                               */
	char    pinc[20];       /* minimum price incremnet              */
	char    pmul[12];       /* price multiplier			            */
	char    fil3[70];       /* Filler 					            */
} MD_MSTR;
