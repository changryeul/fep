...
struct _FX0067_DB_FORM {
    int     CheGyeolNo;                     /* 체결번호         */
    char    CheGyeolDate[8+1];      /* 체결일자         */
    double  GeumAek;                        /* 금액             */
    double  SeonMulHwanYul;                 /* 선물 환율        */
    double  HyeonMulHwanYul;                /* 현물 환율        */
    char    FixingDate[8+1];        /* Fixing Date      */
    char    ValueDate[8+1];         /* Value Date       */
};
...
struct _FX0068_DB_FORM {
    ...
    char    CheGyeolDate[8+1];      /* 체결일자         */
    double  GeumAek;                        /* 금액             */
    char    NearValueDate[8+1];     /* Near value date  */
    char    FarValueDate[8+1];      /* Far value date   */
    int     GiGan;                          /* 기간(일수)       */
    double  MaJin;                          /* 마진(전)         */
};
...
struct _FX0069_DB_FORM {
    ...
    char    CheGyeolDate[8+1];      /* 체결일자         */
    double  GeumAek;                        /* 금액             */
    char    SiJakDate[8+1];         /* 시작일           */
    char    JongRyoDate[8+1];       /* 종료일           */
    int     GiGan;                          /* 기간(일수)       */
...
struct _FX0070_DB_FORM {
    ...
    char    HaengSaManGiDate[8+1];  /* 행사만기일       */
    char    MaeIpEopCheCode[4+1];           /* 매입 업체 코드   */
    char    MaeDoEopCheCode[4+1];           /* 매도 업체 코드   */
};
...
struct _FX0073_DB_FORM {
    ...
    double  HyeonMulHwanYul;                /* 현물 환율        */
    char    GyeolJeDate[8+1];       /* 결제 일자        */
    char    ManGiDate[8+1];         /* 만기 일자        */
