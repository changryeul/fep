...
#define		SMQ_MAX_REC				10000			/* 최대 주문 저장 건수 */
#define		SMQ_REC_SZ				2048			/* 최대 record size */
#define		SMQ_NAME_SZ				32				/* max queue name size */
#define		SMQ_MAX_IDX				30				/* max index 종류  ... */ 
#define		SMQ_IPC_KEY				0xfa002001		/* IPC 접근 key */
#define		SMQ_PIPE_DIR			"/app/fxwin/mat/dat"	/* 20241223 $MAT_DAT로 대체, named pipe path - 파이프 이름은 SMQ_PIPE_DIR/[queue_name].fifo */
