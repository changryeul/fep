...
int Mon_MainInit( MAP *map, MAT *mat, SMQ *smq)
{
	...
	Map_SetField( map,   "cancel_start",Mon_TimeStr, &mat->map->stat.cancel_start);
	Map_SetField( map,   "cancel_end",	Mon_TimeStr, &mat->map->stat.cancel_end);
