...
/***** Module : mon_small.c *****/
int         Mon_SmallMain( MAT *mat, SMQ *smq);                             /* 함수 작성    */
int         Mon_SmallMainInit( MAP *map, MAT *mat, SMQ *smq);               /* 모니터링맵 초기화 */

/***** Module : mon_smq.c *****/
int         Mon_SmqMain( MAT *mat, SMQ *smq);                               /* 함수 작성    */
int         Mon_SmqMainInit( MAP *map, MAT *mat, SMQ *smq);                 /* 모니터링맵 초기화 */

/***** Module : mon_statis.c *****/
int         Mon_StatisMain( MAT *mat, SMQ *smq);                            /* 함수 작성    */
int         Mon_StatisMainInit( MAP *map, MAT *mat, SMQ *smq);              /* 모니터링맵 초기화 */

/***** Module : mon_order.c *****/
int         Mon_Order( MAT *mat, int pos);                                  /* 함수 작성    */
int         Mon_OrderInit( MAP *map, MAT *mat, int line);                   /* 모니터링맵 초기화 */
