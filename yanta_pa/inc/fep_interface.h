...
#define	INT_MEG_SEQ(k)	IF_MEG_SEQ(D_K,P_K,k)	/* interface sequence		*/
...
#define ID_WRITE_CNT    ID_W_CNT(0,0)
#define ID_READ_CNT     ID_R_CNT(0,0)
#define ID_WRITE_CNT2   ID_W_CNT(1,0)
#define ID_READ_CNT2    ID_R_CNT(1,0)
