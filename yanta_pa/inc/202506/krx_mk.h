...
typedef struct
{
	...
	char adj_base_prc               [18];  /* 조정기준가격 */				// 기준가로 할지 조정기준가로 할지.. 우선 기준가로 했음
...
typedef struct
{
	...
	char prc_unit_rule_id             [10];  /* 가격단위규칙ID	*/
											 ...
											 /* 2025.03.04 제도변경건 추가
* '채권일반호가입력', '채권조성호가입력' 전문 호가 제출 시 채권종목정보 전문의 '가격단위규칙ID'에 따른 거부처리
