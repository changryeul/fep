...
#define     SHM_MAX_NOTE_FIF          5000                   /* 3. 국채KTS						*/
...
//  double  each_price[RISK_MK_CNT][SHM_MAX_STOCK];      /* 시장별 종목별 현재가, 장전은 기준가 */
    ...
    PROFIT          ProFit[RISK_MK_CNT][SHM_MAX_STOCK][ACC_NO_CNT];
                                                /* 1000을 나눈값으로 보관       */
    /* ************************************************************************ */
/* 20211024 */
    int     Max_Seq[RISK_MK_CNT];
    STANDARD_SISE_FORMAT            S_Sise[RISK_MK_CNT][SHM_MAX_STOCK];
...
/* 20211028 */
    ORDER_NO    Order_No[3][MAX_AUTO_PROC];         /* 자동주문 프로세스(pa_50101mp) 갯수 */
                                                    /* 0:현물, 1:파생, 3:채권   */
/* 20211102 */
...
#define     FF_SHM_KEY      0x21000002L                 /* 금융상품선물	*/
